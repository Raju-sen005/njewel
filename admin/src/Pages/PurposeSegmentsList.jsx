...
function PurposeSegmentsList() {
    ...
    const fetchCustomers = async () => {
        try {
            ...
            const res = await axios.get(`${baseURL}/purpose`, { headers });
    ...
    const handleSubmit = async (values, { resetForm }) => {
        ...
        try {
            if (editingcustomer) {
                await axios.put(`${baseURL}/purpose/${editingcustomer.id}`, payload, { headers });
            } else {
                await axios.post(`${baseURL}/purpose`, payload, { headers });
            }
    ...
    const handleDelete = async (customerId) => {
        ...
        try {
            await axios.delete(`${baseURL}/purpose/${customerId}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
                ...
                <div className="lg:ml-64 ml-0">
                    ...
                    <main className="p-4 lg:p-6">
                        <div className="flex justify-between p-4">
                            <h1 className="text-2xl font-semibold">Purpose Management</h1>
                            <button
                                    ...
                                    {Customers.length > 0 ? (
                                        Customers.map((customer, index) => (
                                            <tr key={customer.id} className="border-b hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <td className="p-4">{customer.purpose}</td>
                        ...
                        {showForm && (
                            ...
                            <Formik
                                initialValues={{
                                    purpose: editingcustomer?.purpose || '',
                                ...
                                {() => (
                                    <Form className="p-4 mt-6 bg-white shadow rounded-md max-w-md mx-auto">
                                        <h2 className="text-xl font-semibold mb-4">
                                            {editingcustomer ? 'Edit Purpose' : 'Create Purpose'}
                                        </h2>
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            >
                                                {editingcustomer ? 'Update Purpose' : 'Add Purpose'}
                                            </button>
                                            <button
                                                type="button"
...
export default PurposeSegmentsList