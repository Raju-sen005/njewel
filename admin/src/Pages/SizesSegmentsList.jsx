...
function SizesSegmentsList() {
    ...
    const fetchCustomers = async () => {
        try {
            ...
            const res = await axios.get(`${baseURL}/size`, { headers });
    ...
    const handleSubmit = async (values, { resetForm }) => {
        ...
        try {
            if (editingcustomer) {
                await axios.put(`${baseURL}/size/${editingcustomer.id}`, payload, { headers });
            } else {
                await axios.post(`${baseURL}/size`, payload, { headers });
            }
    ...
    const handleDelete = async (customerId) => {
        ...
        try {
            await axios.delete(`${baseURL}/size/${customerId}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
                ...
                <div className="lg:ml-64 ml-0">
                    ...
                    <main className="p-4 lg:p-6">
                        <div className="flex justify-between p-4">
                            <h1 className="text-2xl font-semibold">Sizes Management</h1>
                            <button
                                    ...
                                    {Customers.length > 0 ? (
                                        Customers.map((customer, index) => (
                                            <tr key={customer.id} className="border-b hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <td className="p-4">{customer.size}</td>
                                ...
                                {() => (
                                    <Form className="p-4 mt-6 bg-white shadow rounded-md max-w-md mx-auto">
                                        <h2 className="text-xl font-semibold mb-4">
                                            {editingcustomer ? 'Edit Size' : 'Create Size'}
                                        </h2>
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            >
                                                {editingcustomer ? 'Update Size' : 'Add Size'}
                                            </button>
                                            <button
                                                type="button"
...
export default SizesSegmentsList