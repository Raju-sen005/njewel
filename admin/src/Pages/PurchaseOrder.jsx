    ...
    return (
        <>
            <>
                    ...
                    <header className="bg-white dark:bg-neutral-800 dark:border-gray-700 px-6 py-4 ">
                        <div className="flex items-center justify-between ">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div className="relative">
                                    <div className="flex items-center justify-end gap-2 mx-0 text-white dark:bg-neutral-800 dark:text-white">
                                        <div>
                                            {" "}
                                            <button id="user-menu-btn" className=" rounded-full">
                                                <img
                                        ...
                                        <div>
                                            <p className="font-semibold text-black  dark:text-white hidden md:block">
                                                Robbie Darwis
                                            </p>
                                    ...
                                    <div
                                        id="user-menu"
                                        className="absolute right-0 w-48 bg-white shadow-lg rounded-lg hidden"
                                    >
                                        <div className="p-4 bg-gray-200 rounded-t-lg">
                                            <p className="text-sm text-gray-600">Signed in as</p>
                                            <p className="text-sm font-medium">james@site.com</p>
                                        </div>
                                        <div className="p-2">
                                            <a
                                                href="#"
                ...
                <div className="lg:ml-64  ml-0 dark:bg-neutral-800 dark:text-white ">
                    <main className="p-6">
                        <div className="lg:items-center justify-between gap-4 mb-6 md:flex md:space-y-0 space-y-4">
                            <h2 className="text-2xl font-semibold">Purchase Orders</h2>
                            <div className="md:space-y-0 space-y-4">
                                <button className="py-2 sm:px-4 px-[40%] text-base text-blue-500 border border-blue-600 rounded-lg">
                                    Export
                                </button>
                                <button className="py-2 sm:px-4  px-[32%] px-16 text-base text-white bg-blue-500 rounded-lg">
                                    <a href="Desktop Purchase Orders List - Create Purchase Order.html">
                                        {" "}
                                        Purchase Order
                                    </a>
                                </button>
                        ...
                        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                            <div className=" w-full lg:w-auto flex flex-wrap gap-2">
                                <div className="flex flex-wrap gap-2">
                                    <a
                                        href="#"
                                        className="text-l text-white dark:bg-gray-800 border rounded py-2 px-4 font-semibold bg-blue-500"
                                    >
                                        All{" "}
                                    </a>
                                    <a
                                        href="#"
                                        className="text-l text-black  bg-white dark:bg-gray-800 border rounded py-2 px-4 font-semibold"
                                    >
                                        Ordered{" "}
                                    </a>
                                    <a
                            ...
                            <table className="min-w-full bg-white dark:bg-gray-800 rounded">
                                <thead className="text-left">
                                    <tr className="text-[14px]">
                                        ...
                                        <th className="px-4 py-2 text-gray-500">Destination</th>
                                        <th className="px-4 py-2 text-gray-500">Status</th>
                                        <th className="px-4 py-2 text-gray-500  ">Received</th>
                                        <th className="px-4 py-2 text-gray-500">Total</th>
                                        <th className="px-4 py-2 text-gray-500">Expected Arrival</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {/* Row 1 */}
                                    <tr className="hover:bg-[#F2F3FE] dark:hover:bg-gray-700 cursor-pointer">
                                        ...
                                        <td className="px-4 py-2">Robbi Darwis</td>
                                        <td className="px-4 py-2">123 Elm Street, Springfield, USA</td>
                                        <td className=" text-black ps-4 ">
                                            <span className="bg-[#EDEDED] border-2 border-[#F5F5F5] px-2 py-1 rounded-lg ">
                                                Draft
                                            </span>
                                        </td>
                                        <td className="px-4 py-2">
                                            <span className="px-3 py-1 ">2 of 2</span>
                                        </td>
                                        <td className="px-4 py-2">
                                        ...
                                        <td className="px-4 py-2">
                                            {" "}
                                            <button className="">Apr 29, 2024</button>
                                        </td>
                                    </tr>
                                    {/* Row 2 */}
                                    <tr className="hover:bg-[#F2F3FE] dark:hover:bg-gray-700 cursor-pointer">
                                        ...
                                        <td className="px-4 py-2">456 Oak Lane, Lakeside, UK</td>
                                        <td className="px-2 py-2 text-[#6633D1]">
                                            <span className="bg-[#D0BDF8]  border-4 border-[#D0BDF8] px-2 py-1 rounded-lg">
                                                Ordered
                                            </span>
                                        </td>
                                        <td className="px-4 py-2">
                                        ...
                                        <td className="px-4 py-2">
                                            {" "}
                                            <button className="">Apr 27, 2024</button>
                                        </td>
                                    </tr>
                                    {/* Row 3 */}
                                    <tr className="hover:bg-[#F2F3FE] dark:hover:bg-gray-700 cursor-pointer">
                                        ...
                                        <td className="px-4 py-2">678 Willow Way, Valleydale, India</td>
                                        <td className="px-4 py-2 text-[#D5B032]">
                                            <span className=" bg-[#FFF9E5] border-2 border-[#FFF9E5] px-2 py-1 rounded-lg">
                                                Partial
                                            </span>
                                        </td>
                                        <td className="px-4 py-2">
                                        ...
                                        <td className="px-4 py-2">
                                            {" "}
                                            <button className="">Apr 26, 2024</button>
                                        </td>
                                    </tr>
                                    {/* Row 4 */}
                                    <tr className="hover:bg-[#F2F3FE] dark:hover:bg-gray-700 cursor-pointer">
                                        ...
                                        <td className="px-4 py-2">345 Ash Street, Riverside, Japan</td>
                                        <td className="px-2 py-2 text-[#46B277]">
                                            <span className=" bg-[#C5EED8] border-2 border-[#F5FFFA] px-2 py-1 rounded-lg">
                                                Received
                                            </span>
                                        </td>
                                        <td className="px-4 py-2">
                                            <span className="px-3 py-1">0 of 2</span>
                                        </td>
                                        <td className="px-4 py-2">
                                            <span className="px-3 py-1 ">
                                                <button>$80.00</button>
                                        ...
                                        <td className="px-4 py-2">
                                            {" "}
                                            <button className="">Apr 25, 2024</button>
                                        </td>
                                    </tr>
                                    {/* Row 5 */}
                                    <tr className="hover:bg-[#F2F3FE] dark:hover:bg-gray-700 cursor-pointer">
